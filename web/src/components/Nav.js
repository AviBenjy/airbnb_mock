...
class Nav extends React.Component {
  ...
  render() {
    ...
    const modal = <Modal onClose={this.handleCloseModal} content={openLogIn ? <LogIn/> : <SignUp/>}/>
    return (
      <NavBar>
        
        {(openLogIn ||  openSignUp) && modal}
        ...
        <Tabs>
          ...
          <NavItem onClick={() => this.handleClick('openSignUp')}> Sign up </NavItem>
          <NavItem onClick={() => this.handleClick('openLogIn')}> Log in </NavItem>
        </Tabs>
      </NavBar>
    );
  }
